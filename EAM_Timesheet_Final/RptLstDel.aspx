<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RptLstDel.aspx.cs" Inherits="RptLstDel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     <h2 align="center">
        LIST OF DELIVERABLES LOCATION WISE DETAILS</h2>
    <p>
    <div>
...
<asp:BoundField DataField="DELDESC" HeaderText="Delivery Description" />
