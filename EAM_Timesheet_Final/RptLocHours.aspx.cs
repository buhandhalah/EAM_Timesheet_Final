...
public partial class RptLocHours : System.Web.UI.Page
{
    ...
    protected void BindGridview()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select LOCDESC,WORKHRS,USERNAME from TRANSACTIONS Order by LOCDESC", con);
