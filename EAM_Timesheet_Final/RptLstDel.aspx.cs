...
public partial class RptLstDel : System.Web.UI.Page
{
    ...
    protected void BindGridview()
    {
        SqlConnection con = new SqlConnection("Data Source=ANONYMOUS-PC\\SQLEXPRESS;Initial Catalog=EmployeeDB;User ID=sa;Password=Mo7am00d");
                con.Open();
        SqlCommand cmd =
            new SqlCommand("select LOCMASTER.LOCDESC,DELMASTER.DELDESC from DELMASTER INNER JOIN LOCMASTER ON DELMASTER.LOCID = LOCMASTER.LOCID"
            , con);
